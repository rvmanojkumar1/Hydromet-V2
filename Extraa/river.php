...
<tr>
 ...
 <!-- <th  style="background-color:#539CCC;color:white;text-align:center;font-size: 13px">Sensor</th>-->
     ...
     <th style="background-color:#539CCC;color:white;text-align:center;font-size: 13px;"><a style="color:white" >Water level (ft)</a></th>
          
    
     <th style="background-color:#539CCC;color:white;text-align:center;font-size: 13px;"><a style="color:white" >Discharge (cfs)</a></th>
     
     <th style="background-color:#539CCC;color:white;text-align:center;font-size: 13px;"><a style="color:white" >Water level Change (1000 hr)</a></th>
     ...
     <th style="background-color:#539CCC;color:white;text-align:center;font-size: 13px;"><label style="color:white" >Flood Stage (ft)</label></th>
      ...
      <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Water level','SF1')">Water level</a></td>

   
                                 
      <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Discharge','SF1')">Discharge</a></td>

      <td style="text-align:center;font-size: 13px;height: 14px;"><a>Water level Change (1000 hr)</a></td>
    ...
    <tr>
      <td style="text-align:center;font-size: 13px;height: 14px;"><a>SF15</a></td>
                               
      <td style="text-align:center;font-size: 13px;height: 14px;"><a>2018-02-15 12:15:00</a></td>
                               
                                    
      <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Reservoir Storage','SF15')">Reservoir Storage</a></td>

   
                                 
      <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Discharge','SF15')">Discharge</a></td>
     ...
     <tr>
      ...
      <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Water level','SF7')">Water level</a></td>

   
                                 
      <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Discharge','SF7')">Discharge</a></td>
