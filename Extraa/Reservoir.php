...
<tr>
<td colspan="2">
<label>Reservoir  Network Template
</label>
<td>
</tr>
 ...
 <!-- <th  style="background-color:#539CCC;color:white;text-align:center;font-size: 13px">Sensor</th>-->
   ...
   <th style="background-color:#539CCC;color:white;text-align:center;font-size: 13px;"><a style="color:white" >Reservoir Storage (% of Reservoir Capacity) </a></th>
     ...
     <th style="background-color:#539CCC;color:white;text-align:center;font-size: 13px;"><label style="color:white" >Reservoir Capacity (ac-ft)</label></th>
      ...
      <tr>
      <td style="text-align:center;font-size: 13px;height: 14px;"><a>SF11</a></td>
                               
      <td style="text-align:center;font-size: 13px;height: 14px;"><a>2018-02-15 12:15:00</a></td>
                               
                                    
      <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Reservoir Level','SF11')">Reservoir Level</a></td>

         <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Storage','SF11')">Storage</a></td>
                                 
      <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Storage','SF11')">Storage (% of Reservoir Capacity) </a></td>
    ...
    <tr>
      ...
      <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Reservoir Level','SF12')">Reservoir Level</a></td>

         <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Storage','SF12')">Storage</a></td>
                                 
      <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Storage','SF12')">Storage (% of Reservoir Capacity) </a></td>
    ...
    <td style="text-align:center;font-size: 13px;height: 14px;"><label>Reservoir Capacity (ac-ft)</label></td>                              
     ...
     <tr>
      <td style="text-align:center;font-size: 13px;height: 14px;"><a>SF16</a></td>
                               
      <td style="text-align:center;font-size: 13px;height: 14px;"><a>2018-02-15 12:15:00</a></td>
                               
                                    
      <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Water level','SF16')">Water level</a></td>

         <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Storage','SF16')">Storage</a></td>
                                 
      <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Storage','SF16')">Storage (% of Reservoir Capacity) </a></td>
