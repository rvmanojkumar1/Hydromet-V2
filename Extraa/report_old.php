...
if(isset($_POST['chekedstn']))
{
  ...
  foreach($checkbox1 as $chk1)  
   ...
   //echo "<script>window.location.href='report_old.php?select1='+$stnnames<script>";
 
  // header("Location : report_old.php?select1=$stnnames");
}
?>
  ...
  return;
          ...
          if (type=="Daily") {
           ...
           // var params = document.getElementById("SensorList").value;
              ...
              window.location.href= 'report_old.php?FY=' + yearFrom + "&FM=" + monthFrom + "&FD=" + dayFrom + "&PARAMS=" + params+"&station="+station+"&type=Daily&report_type="+typereport;
             }
           ...
           var yearFrom=$("#years option:selected").val();
            var monthFrom=$("#months option:selected").val();
              window.location.href= 'report_old.php?FY=' + yearFrom + "&FM=" + monthFrom + "&PARAMS=" + params+"&station="+station+"&type=Monthly&report_type="+typereport;
         }
         else if (type=="Annual")
         {

           var yearFrom=$("#Annual_years option:selected").val();
              window.location.href= 'report_old.php?FY=' + yearFrom + "&PARAMS=" + params+"&station="+station+"&type=Annual&report_type="+typereport;
         }
         }
...
$("#report_type").change(function()
  {
    var val=$("#report_type").val();
       ...
       window.location.href="report_old.php?report_type="+val;
...
$(document).ready(function()
  {
    ...
    function GetData()
    {
      ...
      window.location.href='report_old.php?station='+stn+"&report_type="+val;//"&type="+type_of_report;
