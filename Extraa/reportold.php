...
if(isset($_POST['chekedstn']))
{
  ...
  foreach($checkbox1 as $chk1)  
   ...
   //echo "<script>window.location.href='reportold.php?select1='+$stnnames<script>";
 
  // header("Location : reportold.php?select1=$stnnames");
}
?>
  ...
  return;
          ...
          if (type=="Daily") {
            ...
            if (jsFromDate =="Invalid Date") {
               ...
               dayFrom = jsFromDate.getDate()+1;   // where getDate returns the day of the month (from 1-31)
            }
           ...
           // var params = document.getElementById("SensorList").value;
              ...
              window.location.href= 'reportold.php?FY=' + yearFrom + "&FM=" + monthFrom + "&FD=" + dayFrom + "&PARAMS=" + params+"&station="+station+"&type=Daily&report_type="+typereport;
             }
           ...
           var yearFrom=$("#years option:selected").val();
            var monthFrom=$("#months option:selected").val();
              window.location.href= 'reportold.php?FY=' + yearFrom + "&FM=" + monthFrom + "&PARAMS=" + params+"&station="+station+"&type=Monthly&report_type="+typereport;
         }
         else if (type=="Annual")
         {

           var yearFrom=$("#Annual_years option:selected").val();
              window.location.href= 'reportold.php?FY=' + yearFrom + "&PARAMS=" + params+"&station="+station+"&type=Annual&report_type="+typereport;
         }
         }
...
$("#report_type").change(function()
  {
    var val=$("#report_type").val();
       ...
       window.location.href="reportold.php?report_type="+val;
...
$(document).ready(function()
  {
    ...
    function GetData()
    {
      ...
      window.location.href='reportold.php?station='+stn+"&report_type="+val;//"&type="+type_of_report;
...
<?php if (isset($_GET['FY'])&&isset($_GET['FM'])&&isset($_GET['FD'])) {
      ...
      $da= strtotime( $_GET['FY'].'/'.$_GET['FM'].'/'.$_GET['FD']);
    	...
    	<td>
                <input style="width: 100%" type="date" name="EditStartDate" id="EditStartDate" class="form-control" required value="<?php if(isset($da)) { echo date('Y-m-d',$da);} ?>" >
