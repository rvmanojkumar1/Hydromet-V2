...
function emptyHours()
{
  ...
  <center>
   <table style="width: 100%;">
	...
	<tr>
  <td style="padding-left: 3px"> <div class="form-group">  <select  id="selectgraph" onchange="val()" class="form-control">
...
$_SESSION['SName']=$_GET['station']; 
	...
	?>'> </div>
		...
		<td class="pad"> <div class="form-group"> <select style="width:  100%" name="SensorList" id="SensorList" onchange="PlotGraph()" class="form-control" required >
