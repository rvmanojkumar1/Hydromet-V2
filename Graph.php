...
<option value="" disabled selected>Sensor</option>
 ...
 echo $_GET['hours2'];
   ...
   <td class="td-inline-element">  <label >From</label>
...
//echo date('Y-n-j')."  AND  ".$da;
   ...
   <td class="td-inline-element" style="padding-left: 3px"> <div class="form-group"> <input style="width: 100%" type="date" name="EditStartDate" id="EditStartDate" class="form-control" required value="<?php if(isset($da)) { echo date('Y-m-d',$da);} ?>" onChange="emptyHours()"></div></td>
   <td class="td-inline-element" style="padding-left: 3px"><label> To</label>  </td>
   <td class="td-inline-element" style="padding-left: 3px"> <div class="form-group"><input style="width: 100%" type="date"  class="form-control" ID="EditEndDate" required value="<?php if(isset($da)) { echo date('Y-m-d',$da2);} ?>" onChange="emptyHours()"></div> </td>
   <td class="pad td-inline-element" >
