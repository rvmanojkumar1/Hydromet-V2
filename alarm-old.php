...
<td ><?php echo $row['AlarmEmail']; ?></td>
              ...
              <td ><div style="height: 20px;width: 250px;overflow-y: auto;"><?php echo $users; ?></div></td>
           <center>
...
$row_span= $span_set[0];
    ...
    ?>
           ...
           <?php if ($alarm!=$row['AlarmName']) { ?> <td rowspan="<?php echo $row_span; ?>"  style="vertical-align: middle;" ><?php  echo $row['AlarmName']; ?></td> <?php } ?>
            <td ><?php echo $row['Station_Full_Name']; ?></td>
            <td ><?php echo $row['SensorName']; ?></td>
             <td ><?php echo $row['Type']; ?></td>
              <td ><?php echo $row['change']; ?></td>
 ...
 <?php if ($alarm!=$row['AlarmName']) { ?> <td style="vertical-align: middle;" rowspan="<?php echo $row_span; ?>" ><?php  echo $row['AlarmEmail']; ?></td> <?php } ?>
  <?php if ($alarm!=$row['AlarmName']) { ?> <td style="vertical-align: middle;" rowspan="<?php echo $row_span; ?>" ><?php if(trim($row['range'])!="")  echo $row['range']." to ".$row['RangeTo']; ?></td> <?php } ?>

 <?php if ($alarm!=$row['AlarmName']) { ?> <td style="vertical-align: middle;" rowspan="<?php echo $row_span; ?>" ><div style="max-height: 200px;width: 250px;overflow-y: auto;"><?php echo $users; ?></div></td> <?php } ?>
            ...
            <td style="vertical-align: middle;" rowspan="<?php echo $row_span; ?>" align="center" style="width:40px"><a data-toggle="tooltip" title="Detete!" href="javascript:delete_id('<?php echo $row['AlarmName']; ?>')"><img src="b_drop.png" align="DELETE" /></a></td> <?php }?>
            </tr>
        <?php
        $alarm=$row['AlarmName'];
    }
