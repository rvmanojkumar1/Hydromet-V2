...
<link rel="stylesheet" href="/HydrometV2/includes/style.css">
      ...
      <div class="yamm navbar navbar-default" role="navigation">
       ...
       <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
        ...
        <!-- The Station Query dropdown is linked to the /HydrometV2/Selectquery.php page -->
				...
				<li class="dropdown" ><a href="#"  class="head_a" ><img src="/HydrometV2/assets/images/dashboard.png" height="20"> Dashboard</a>
