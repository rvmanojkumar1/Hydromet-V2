        ...
        <table id="myTable1" class="table-bordered table-responsives" style="max-width:90%;min-width:60%;">
          <thead>
            <tr>
              <th>Station</th>
              <?php
                for($f=1;$f<count($array[0]);$f++)
                {
                  if(strpos($array[0][$f], "c-")!==false){
                    $rename=str_replace("c-", "",trim($array[0][$f]));
                    ?>
                      <th><?php echo $rename;?></th>
                    <?php
                  }
                  else{
                    ?>
                      <th><?php echo $array[0][$f];?></th>
                    <?php
                  }
                }
              ?>
