...
<br>
<div style="margin-right:5%;margin-left:2%";>
<center>
<div class="row">
<div class='row'>
<div class='col-md-12'>
...
<tr>
<td colspan="2">
<label>River Network Template ( Table 1 )
</label>
<td>
</tr>
</table>
...
<table align="center" id="myTable1" style="width:auto;" class="table table-bordered table-responsive">
<tr>
...
for (var i = 1; i < tr1.length; i++) {
 // debugger;
  ...
  stationname.push(tr1[i].getElementsByTagName('td')[0].getElementsByTagName('a')[0].innerHTML);
}
...
if (!isNaN(d_a[1]))
 {
  ...
  // console.log(color);
  td1[j].getElementsByTagName('a')[0].style.color=color;
//   if (d_a[1]=="11")
