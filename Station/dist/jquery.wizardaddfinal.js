...
;(function ($, document, window){
	...
	methods = {
		init: function (element, options) {
			...
			//	html += '<span class="'+ opts.btnClass +' '+ opts.btnClassDefault +' btn-next"><span class="next-text">'+ opts.text.next +'</span><span class="finished-text" onClick="submitData()" >Finish</span></span>';
			//	html += '</div></div>';
			...
			if(opts.bottomButtons && !bottomActions.length){
				...
				//html += '<div class="right-actions"><span class="'+ opts.btnClass +' '+ opts.btnClassDefault +' btn-next"><span class="next-text">'+ opts.text.next +'</span><span class="finished-text" onClick="submitData()">Finish</span></span></div>';
				//html += '</div>';
