...
;(function ($, document, window){
	...
	methods = {
		init: function (element, options) {
			...
			//	html += '<span class="'+ opts.btnClass +' '+ opts.btnClassDefault +' btn-prev"><span class="previous-text" onClick="previous()">'+ opts.text.previous +'</span></span>';
			//	html += '<span class="'+ opts.btnClass +' '+ opts.btnClassDefault +' btn-next"><span class="next-text" onClick="stncreate()">'+ opts.text.next +'</span><span class="finished-text" onClick="submitData()" >Finish</span></span>';
			//	html += '</div></div>';
			...
			//	html += '<div class="left-actions"><span class="'+ opts.btnClass +' '+ opts.btnClassDefault +' btn-prev"><span class="previous-text" onClick="previous()" >'+ opts.text.previous +'</span></span></div>';
			//	html += '<div class="right-actions"><span class="'+ opts.btnClass +' '+ opts.btnClassDefault +' btn-next" ><span class="next-text" onClick="stncreate()" formvalidate>'+ opts.text.next +'</span><span class="finished-text" onClick="submitData()">Finish</span></span></div>';
			//	html += '</div>';
...
alert("Station Type has been created successfully!");
 ...
 function stncreate()
 {
 	//var stn=document.getElementById("stntype").value;
//document.stncreateform.submit();
document.getElementByName("stncreateform").submit();
 }