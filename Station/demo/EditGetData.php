...
function OnUserSelect()
{
	...
	var dayVal = eID.options[eID.selectedIndex].value;
	 var daytxt = eID.options[eID.selectedIndex].text;
	  ...
	  window.location.href='EditAlarmStep2.php?select1='+dayVal;
...
if(isset($_GET['Search1']))
{
  ...
  //  $query = $_REQUEST['SearchStation'];
    $sql_query= "select distinct \"StationTypeName\",\"StationField\" from \"DefineStations\"";
