...
?>
              ...
              <td >
                    <label><b>Range from</b></label>
                        ...
                        <td>
              <input type="date" id="range" name="range" placeholder="Range" value="<?php echo $row[1]; ?>"   class="form-control">
                        </td>
<td >
                    <label><b>Range to</b></label>
                        ...
                        <td>
                           <input type="date" id="rangeTo" name="rangeTo" value="<?php echo $row[3];?>"   class="form-control">
                         </td>
         ...
         <td>
                      ...
                      <td>
                        <select class="form-control"  id='optiontype'  name="type">
...
$('body').on('change', '#optiontype', function (){
        debugger;
      var type=  $("#optiontype option:selected").val(); 
...
{
  var tr="<tr><td>"+stn+"</td><td>"+sen+"</td><td>"+type+"</td><td>"+change+"</td><td>"+value+"</td><td>"+time+"<input type='hidden' name='stations[]' value='"+stn+"' /><input type='hidden' name='sensorslist[]' value='"+sen+"' /><input type='hidden' name='types[]' value='"+type+"' /><input type='hidden' name='change[]' value='"+change+"' /><input type='hidden' name='value[]' value='"+value+"' /><input type='hidden' name='times[]' value='"+time+"' /><input type='hidden' name='range' value='"+range+"' /><input type='hidden' name='rangeTo' value='"+rangeTo+"' /> <td>  <a data-toggle='tooltip' title='Delete!' onclick='deleteRow(this)'><img src='b_drop.png' align='DELETE' /></a></td></tr>";
