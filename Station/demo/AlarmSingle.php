                       ...
                       <label><b> Select Sensors</b></label>
                        ...
                        <select name="Sensors" id="SensorList" required="" class="form-control">
                           <option value="" disabled selected>Please Select Sensors</option>
                                                ...
                                                <td> 
                                                  <input type="checkbox" id="setrangeid" name="checkboxforrange" value="0" onchange="setrangeoptional()" <?php if(isset($rows[5])){if($rows[5]!=""){echo "checked";}} ?>><b>Range From</b>
                                                </td>
                        <td>
						
              <input type="text"   name="range" <?php if(isset($rows[5])){if($rows[5]!=""){echo "";}else{ echo "disabled";}}else{echo "disabled";} ?> id = "datepicker-13" value="<?php echo $rows[5];?>" class="form-control">
                  ...
                  <td> <label><b> Range to</b></label></td>
                        ...
                        <td>
              <input type="text" name="rangeTo" <?php if(isset($rows['RangeTo'])){if($rows['RangeTo']!=""){echo "";}else{ echo "disabled";}}else{echo "disabled";} ?> id = "datepicker-14" value="<?php echo $rows['RangeTo'];?>" class="form-control">
