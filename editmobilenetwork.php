...
<head>
	<?php
		...
		$id=$_GET['id'];
		if(isset($_GET['id'])){
			$stmt=pg_query("SELECT \"Network\", \"Desc\", \"At\" FROM \"tblNetwork\" WHERE \"Id\"='$id'");
							...
							<div align="center">
								...
								<form method="Post" action="">
									<table>
										...
										<tr>
											<td><input style="width: 300px;"  type="text" name="mobilenetwork"  id="mobilenetwork" class="form-control" value="<?php echo $result[0]; ?>" required/></td>
										</tr>
										<tr style="margin-top: 2%;">
											<td>At</td>
										</tr>
										<tr>
											<td><input style="width: 300px;"  type="text" name="mobilenetworkat"  id="mobilenetworkat" class="form-control" value="<?php echo $result[2]; ?>" /></td>
										</tr>
										<tr style="margin-top: 2%;">
											<td>Description</td>
										</tr>
										<tr>
											<td><input style="width: 300px;"  type="text" name="mobilenetworkdesc"  id="mobilenetworkdesc" class="form-control" value="<?php echo $result[1]; ?>" /></td>
										</tr>
									</table>
									<br>
									<center>
								...
								<?php
									...
									if(isset($_POST['nextstep'])){
										...
										$sql=pg_query("UPDATE public.\"tblNetwork\" SET \"Network\"='$network', \"Desc\"='$desc', \"At\"='$at' WHERE \"Id\"='$id' returning \"Id\";");
