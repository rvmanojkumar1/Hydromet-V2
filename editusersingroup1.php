...
<head>
	...
	<script type="text/javascript">
		function gotobackstep(){
			...
			var oldgname='<?php echo $groupcheck; ?>';
			window.location.href = 'editusersingroup.php?groupname='+gname+"&oldgroup="+oldgname;
		}
		...
		function EditGroup(){
            ...
            console.log(gname);
            window.location.href="Editgroup.php?id="+displayid+"&group="+gname+"&oldgroup="+oldgname;
	 		...
	 		<div class="col-md-10">
	            <div class="panel panel-primary" style="width:100%;margin: 30px auto;"  >
                  	<div class="panel-heading" style="background-color:#4A7BDF;color:white">
                   		<center><b style="font-size:15px;font-family: arial;" id="gpname"><?php $gn=$_GET['newgroup'];echo $gn; ?></b></center>
                   	</div>
							...
							<div align="center">
								...
								<form method="Post" action="">
									<table align="center" style="width:90%" class="w3-table-all">
										...
										<?php
											$result = pg_query("SELECT \"Username\",\"Email\",\"GroupName\",\"organization\",\"officeno\",\"mobileno\",\"GroupCommunicationWay\" FROM \"tblloginandregister\" where \"approved\"='1' Order by \"Username\"");
											$i=0;
											...
											while($row = pg_fetch_array($result)) 
											{
												...
												$grouppresent=$row["GroupName"];
												$array=explode(",", $grouppresent);
												if($i%2==0)
												$classname="evenRow";
												else
												$classname="oddRow";
												?>
													...
													<td style="text-align:center"><input type="checkbox" name="rowcheckbox" value="<?php echo $row["Username"]; ?>" <?php for($m=0;$m<count($array);$m++){if($groupcheck==$array[$m]){echo "checked";$com_way=$row["GroupCommunicationWay"];break;}}?> ></td>
									...
									<center>
										...
										<input type="button" name="Save" class="btn btn-primary" value="Update" id="Save" onClick="EditGroup();">
