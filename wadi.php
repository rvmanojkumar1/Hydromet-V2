    ...
    <div>
      <div class="yamm navbar navbar-default" role="navigation">
       ...
       <span class="sr-only">Toggle navigation</span> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </button>
        ...
        <li class="dropdown"> <a href="wadi.php"><img src="assets/images/dashboard.png" height="20"> Dashboard</a> </li>
...
<tr>
 ...
 <!-- <th  style="background-color:#539CCC;color:white;text-align:center;font-size: 13px">Sensor</th>-->
     ...
     <th style="background-color:#539CCC;color:white;text-align:center;font-size: 13px;"><a style="color:white" >Water level (m)</a></th>
          
    
     <th style="background-color:#539CCC;color:white;text-align:center;font-size: 13px;"><a style="color:white" >Discharge (cms)</a></th>
     
     <th style="background-color:#539CCC;color:white;text-align:center;font-size: 13px;"><a style="color:white" >Water level Change (24 hr)</a></th>
     
     <th style="background-color:#539CCC;color:white;text-align:center;font-size: 13px;"><label style="color:white" >Flood Stage (m)</label></th>

 
     </tr>
      
      <tr>
      <td style="text-align:center;font-size: 13px;height: 14px;"><a>WadiRahat</a></td>
                               
      <td style="text-align:center;font-size: 13px;height: 14px;"><a>2018-02-15 12:15:00</a></td>
                               
                                    
      <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Water level','WadiRahat')">Water level</a></td>

   
                                 
      <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Discharge','WadiRahat')">Discharge</a></td>

      <td style="text-align:center;font-size: 13px;height: 14px;"><a>Water level Change (24 hr)</a></td>
   
      <td style="text-align:center;font-size: 13px;height: 14px;"><label>Flood Stage (m)</label></td>                              
    
                                 
   </tr>
                   
    <tr>
      <td style="text-align:center;font-size: 13px;height: 14px;"><a>WadiU405</a></td>
                               
      <td style="text-align:center;font-size: 13px;height: 14px;"><a>2018-02-15 12:15:00</a></td>
                               
                                    
      <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Water level','WadiU405')">Water level</a></td>

   
                                 
      <td style="text-align:center;font-size: 13px;height: 14px;"><a style="color:green" href="javascript:PlotGraph('Discharge','WadiU405')">Discharge</a></td>
