							...
							<div class="col-lg-12" >
								...
								<form  method="post" role="form" action="Login.php">
									...
									<div class="form-group">
										 <input type="text" name="username" id="username" class="form-control" Required  oninvalid="this.setCustomValidity('Please Enter Username!')" oninput="setCustomValidity('')" placeholder="Username"/>
								</div>
									<div class="form-group">
										<input type="password" name="password" id="password" Class="form-control" Required  oninvalid="this.setCustomValidity('Please Enter Password!')" oninput="setCustomValidity('')" placeholder="Password"/>
