            ...
            <div class="row"> 
                <div class="col-xs-12 col-sm-12 col-md-12 sidebar"> 
                    ...
                    <?php
                        ...
                        <link rel="stylesheet" href="style.css?ver=1.0" type="text/css" />
                        ...
                        <div style="width:100%;margin:auto">
                            ...
                            <br />
                                ...
                                <div class="panel panel-primary" style="width:70%;margin: 0 auto;"  >
                                    <div class="panel-heading" style="background-color:#4A7BDF;color:white"><center><b style="font-size:15px;font-family: arial;">Delete User</b></center></div>
                                                ...
                                                <div style="width:70%;margin: 0 auto ; background-color: white">
                                                    <table align="center" style="width:90%" class="w3-table-all">
                                                        ...
                                                        <tr class="<?php if(isset($classname)) echo $classname;?>">
                                                            ...
                                                            <td style="text-align:center"><label class="switch"><input type="checkbox" name="users[]" id="togglevalue" <?php echo($row['enabled']=='t') ? 'checked' : 'unchecked';?> value="<?php echo $row["Username"]; ?>"><span class="slider round"></span></label></td>
                                                            <!-- <td style="text-align:center"><div class="custom-control custom-switch">
                                                    ...
                                                    <br>
                                                    <center>
                                                        <input type="" style="width: 100px;" name="delete" class="btn btn-danger" value="Submit" onclick="setDeleteAction();" />
                                                    </center>
                                                </form>
                                            </div>
                                        </div>
